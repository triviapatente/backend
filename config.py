...
SQLALCHEMY_DATABASE_URI = 'postgresql://ted:ted@postgres:5432/triviapatente'
SQLALCHEMY_TEST_DATABASE_URI = 'postgresql://ted:ted@postgres:5432/triviapatente_test'
